...
def call_hoplite_agent(payload: Dict[str, Any], test_mode: bool = False, app_mode: bool = False) -> Optional[Dict[str, Any]]:
    ...
    if test_mode:
        ...
        instruction = (
            ...
            "The message MUST include approximately how many days of supply remain, using the supplied days_remaining value. "
            "Round days_remaining to the nearest whole day for the human-facing message; if it is below 1 day, say 'less than 1 day'. "
            "Never mention exact quantities, weights, measurements, consumption rates, dates, or other backend numbers. "
            ...
            "For the current safe status, use this exact message, followed by a short sentence stating the approximate days of supply remaining: "
            "'Your army is strong and well supplied. I shall keep watch over your soldiers and alert you if I see anything change.' "
            "For LOW_STOCK_NOTIFICATION, use this exact message, followed by a short sentence stating the approximate days of supply remaining: "
            "'I see a soldier growing tired. A tired warrior can weaken the army. Plan to replenish his supplies soon.' "
            "For URGENT_REPLENISHMENT_NOTIFICATION, use this exact message, followed by a short sentence stating the approximate days of supply remaining: "
